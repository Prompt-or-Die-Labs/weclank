	...
	body.innerHTML = `
		...
		<section class="help-dialog__section">
			...
			<dl>
				...
				<dt><kbd>⌘ ⇧ R</kbd></dt><dd>Start / stop local recording (same as the header <strong>REC</strong> / <strong>STOP</strong> button). You pick a folder; the file is <strong>MP4</strong> (H.264 + AAC) produced by ffmpeg after you stop. When you stop, a <strong>Review recording</strong> window opens with preview, timeline range handles, a clip queue, MP4 clip export, vertical short export, delete, and share controls. MediaRecorder still captures WebM internally, then the main process transcodes.</dd>
